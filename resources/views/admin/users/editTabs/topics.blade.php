                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    @can('admin_forum_topics_lists')
                                        @if(!$topic->close)
                                            @include('admin.includes.delete_button',[
                                                'url' => getAdminPanelUrl('/')."/forums/{$topic->forum_id}/topics/{$topic->id}/close",
                                        ...
                                        @else
                                            @include('admin.includes.delete_button',[
                                                'url' => getAdminPanelUrl('/')."/forums/{$topic->forum_id}/topics/{$topic->id}/open",
                                    ...
                                    @can('admin_enrollment_block_access')
                                        @include('admin.includes.delete_button',[
                                                'url' => getAdminPanelUrl('/')."/forums/{$topic->forum_id}/topics/{$topic->id}/delete?no_redirect=true",
                                            ])
                                    @endcan
                                </td>
                            </tr>
