    ...
    <div class="text-danger"> * {{ trans('public.required') }}</div>
        ...
        <div class="form-group mt-15 ">
            ...
            <select name="type" class="custom-select @error('type')  is-invalid @enderror">
                <option value="webinar" @if(!empty($webinar) and $webinar->isWebinar()) selected @endif>{{ trans('product.video_course') }}</option>
                <option value="course" @if(!empty($webinar) and $webinar->type == 'course') selected @endif>{{ trans('product.audio_course') }}</option>
                <option value="text_lesson" @if(!empty($webinar) and $webinar->type == 'text_lesson') selected @endif>{{ trans('product.text_course') }}</option>
            </select>
        ...
        @if($isOrganization)
            <div class="form-group mt-15 ">
                <label class="input-label d-block">{{ trans('public.select_a_teacher') }}<span class="text-danger"> *</span></label>
        ...
        <div class="form-group mt-0">
            <label class="input-label font-12">{{ trans('public.demo_video') }} ({{ trans('public.optional') }})</label>
