<div class="dropdown">
    <button type="button" class="btn btn-transparent" {{ (empty($unReadNotifications) or count($unReadNotifications) < 1) ? 'disabled' : '' }} id="navbarNotification" aria-label="notifikasi" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
