...
// inputtags
    ...
    $(document).ready(function () {
        ...
        handleSearchableSelect2('search-user-select2', '/manajer/users/search', 'name');

        handleSearchableSelect2('search-user-select22', '/manajer/users/search', 'name');

        handleSearchableSelect2('search-webinar-select2', '/manajer/webinars/search', 'title');

        handleSearchableSelect2('search-bundle-select2', '/manajer/bundles/search', 'title');

        handleSearchableSelect2('search-forum-topic-select2', '/manajer/forums/topics/search', 'title');

        handleSearchableSelect2('search-product-select2', '/manajer/store/products/search', 'title');

        handleSearchableSelect2('search-category-select2', '/manajer/categories/search', 'title');

        handleSearchableSelect2('search-blog-select2', '/manajer/blog/search', 'title');
